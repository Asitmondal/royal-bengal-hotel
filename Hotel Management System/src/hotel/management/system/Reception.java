...
public class Reception extends JFrame implements ActionListener {
    JButton newCustomer, rooms, department, employee,customers, managerInfo, searchRoom;
    JButton logout, checkout, update, roomStatus, pickup;
    Reception(){
        ...
        ImageIcon il = new ImageIcon(ClassLoader.getSystemResource("img/fourth.jpg"));
